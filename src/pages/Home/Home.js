  ...
  <>
    ...
    <div className="Home">
      ...
      <p>
        ...
        for domains. The droplet simply uses Nginx and PM2 for running the Node app. I haven't decided between
        AWS or DO for an S3 solution to host images. I also have been working with a Docker Swarm of three
        droplets on DO, but I'd like to improve my Docker understanding further before containerizing my apps.
    </p>
